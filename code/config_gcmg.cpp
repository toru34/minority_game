...
const int N_MINORITY_AGENTS = 0;
const int N_PRODUCER_AGENTS = 1000; // 1000 or 1200
const int N_SPECULATOR_AGENTS = 501; // 501 or 1001

const int N_AGENTS = N_MINORITY_AGENTS + N_PRODUCER_AGENTS + N_SPECULATOR_AGENTS;

const float EPS = 0.01;

const int N_ITERS = 50000;
const int N_RUNS = 1;
...
std::uniform_int_distribution<int> rng_nagents_integer(- N_AGENTS, N_AGENTS); // x ~ {- N_AGENTS, ..., 0, ..., N_AGENTS}
